...
public class AFTreap extends Treap{
    public Node root;
    private int size = 0;
    ...
    public Node search (Integer key){
        ...
        if (size == 0){
            ...
            Node toReturn = searchHelper(root, key);
            double newPrio = rand.nextDouble();
            if(newPrio > toReturn.getPriority()){
                toReturn.changePriority(newPrio);
                siftUp(toReturn);
            }
            return toReturn;
        }
